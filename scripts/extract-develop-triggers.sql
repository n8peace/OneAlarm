-- Extract Develop Environment Triggers
-- Run this in the DEVELOP environment SQL editor to get exact trigger definitions

-- Extract trigger_audio_generation function
SELECT 
    '-- Develop Environment: trigger_audio_generation function' as comment,
...
SELECT 
    '-- Develop Environment: Triggers on user_preferences' as comment,
...
SELECT 
    '-- Develop Environment: Audio-related functions' as comment,
...
SELECT 
    '-- Develop Environment: All triggers' as comment,
    tgname as trigger_name,
    tgrelid::regclass as table_name,
    tgfoid::regproc as function_name,
    pg_get_triggerdef(oid) as trigger_definition
